...
export default function EnterNewPass() {
  ...
  const handleResetPassword = (event: React.SubmitEvent<HTMLFormElement>) => {
    ...
    if (newPassword !== password) {
      setNewPasswordError("Your confirm password doesn't match.");
      valid = false;
    }

    if (!valid) return;

    console.log("Send to backend - Reset Password");
  };
