          ...
          <section className="w-full max-w-[520px] rounded-[20px] bg-white p-6 shadow-[0px_24px_60px_rgba(15,23,42,0.08)] sm:p-8">
            ...
            <form className="mt-8 flex flex-col gap-4">
              <label className="flex flex-col gap-2 self-stretch">
                ...
                <div className="flex h-12 items-center justify-between rounded-[10px] border border-zinc-200 bg-white px-3">
                  <span className="font-['Inter_Tight'] text-base leading-6 tracking-tight text-zinc-950">
                    ••••••••••
                  </span>
                  <svg
                    width="24"
                  ...
                  >
                    <path
                      d="M11.9997 5C15.079 5.00005 18.0176 6.81851 20.113 10.1592C20.8183 11.2839 20.8183 12.7161 20.113 13.8408C18.0176 17.1815 15.079 19 11.9997 19C8.92042 19 5.98189 17.1815 3.88643 13.8408C3.18109 12.7161 3.18109 11.2839 3.88643 10.1592C5.98189 6.81851 8.92042 5 11.9997 5ZM11.9997 7C9.7742 7 7.40786 8.30884 5.58076 11.2217C5.28288 11.6966 5.28288 12.3034 5.58076 12.7783C7.40786 15.6912 9.7742 17 11.9997 17C14.2252 17 16.5916 15.6911 18.4187 12.7783C18.7165 12.3034 18.7165 11.6966 18.4187 11.2217C16.5916 8.30885 14.2252 7.00005 11.9997 7ZM11.9997 8C14.2088 8.00006 15.9997 9.7909 15.9997 12C15.9997 14.2091 14.2088 15.9999 11.9997 16C9.79057 16 7.99971 14.2091 7.99971 12C7.99971 9.79086 9.79057 8 11.9997 8ZM11.9138 10.0039C11.9683 10.1594 11.9997 10.3259 11.9997 10.5C11.9997 11.3284 11.3281 11.9999 10.4997 12C10.3257 12 10.159 11.9686 10.0036 11.9141C10.0024 11.9426 9.99971 11.9712 9.99971 12C9.99971 13.1046 10.8951 14 11.9997 14C13.1042 13.9999 13.9997 13.1045 13.9997 12C13.9997 10.8955 13.1042 10.0001 11.9997 10C11.9709 10 11.9423 10.0027 11.9138 10.0039Z"
                      fill="#818898"
                    />
                  </svg>
                </div>
              ...
              <label className="flex flex-col gap-2 self-stretch">
                ...
                <div className="flex h-12 items-center justify-between rounded-[10px] border border-sky-500 bg-white px-3 shadow-[0px_0px_0px_3px_rgba(11,117,249,0.16)]">
                  <span className="font-['Inter_Tight'] text-base leading-6 tracking-tight text-zinc-950">
                    •••••
                  </span>
                  <span className="font-['Inter_Tight'] text-base leading-6 tracking-tight text-sky-600">
                    |
                  </span>
                  <svg
                    width="24"
